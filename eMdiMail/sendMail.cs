...
namespace eMdiMail
{
    class sendMail:IDisposable
    {
        ...
        EmailMessage eMail;
        public String _to = "heinz-josef.gode@intermec.com";
...
/*
            ...
            strTemp += "      <parm name=\"AUTHNAME\" value=\"logimat2011@googlemail.com\" />\r\n";
            strTemp += "      <parm name=\"DOMAIN\" value=\"\" />\r\n";
            strTemp += "      <parm name=\"OUTSERVER\" value=\"smtp.googlemail.com\" />\r\n";
            strTemp += "      <parm name=\"REPLYADDR\" value=\"logimat2011@googlemail.com\" />\r\n";
            strTemp += "      <parm name=\"SMTPALTAUTHNAME\" value=\"logimat2011@googlemail.com\" />\r\n";
            strTemp += "      <parm name=\"SMTPALTDOMAIN\" value=\"\" />\r\n";
            strTemp += "      <parm name=\"NAME\" value=\"Logi Mat 2011\" />\r\n";
            ...
            strTemp += "      <parm name=\"AUTHSECRET\" value=\"intermec\"/>\r\n";
